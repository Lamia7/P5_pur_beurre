...
TABLES['product_store'] = ("CREATE TABLE IF NOT EXISTS `product_store` ("
                           ...
                           "FOREIGN KEY (`product_id`)"
                           "REFERENCES " + DATABASE_NAME + ".`product` (`id`)"
                                                           "ON DELETE CASCADE "  # empeche suppression du parent et enfant (autre option: CASCADE)
                                                           "ON UPDATE NO ACTION,"
...
# -------- DELETE QUERIES -------- #
DELETE_DATABASE = "SET FOREIGN_KEY_CHECKS=0; DROP DATABASE IF EXISTS " + DATABASE_NAME + ";"
DELETE_TABLES_EXCEPT_FAVORITE = "DROP TABLES category, product, product_category, product_store, store;"
DELETE_FAVORITE = "DROP TABLE favorite;"
